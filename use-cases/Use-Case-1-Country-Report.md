# USE CASE: 1 Report on all countries ordered by population from largest to smallest
## CHARACTERISTIC INFORMATION
### Goal in context
Produce a report on all the countries in the world ordered by population from largest to smallest. The report should
have columns: Code, Name, Continent, Region, Population, Capital.
### Scope
...
**SQL query fails**: System logs the error.
## SCHEDULE
31/07/26
